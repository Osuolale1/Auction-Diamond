...
contract AuctionMarketFaucet is IERC721Receiver {
    ...
    function createAuction(
        ...
        require(
            ...
            "AuctionMarket: invalid category"
        );
        require(
            _endAuction > block.timestamp,
            "AuctionMarket: endAuction must be in the future"
        );
        require(
            _minBid > 0,
            "AuctionMarket: minBid must be greater than 0"
        );

        require(
            LibAppStorage.isContract(_addressNFTCollection),
            "AuctionMarket: invalid NFT Collection address"
        );
    ...
    function placeBid(
        ...
        require(
            ...
            "AuctionMarket: auction does not exist"
        );
        ...
        if (auction.currentBidOwner == address(0)) {
            require(
                ...
                "AuctionMarket: not enough allowance to transfer"
            );
            ...
            require(
                ...
                "AuctionMarket: failed to transfer bid amount"
            );
        }
        ...
        if (
            ...
            require(
                ...
                "AuctionMarket: failed to transfer previous bid amount"
            );
    ...
    function refund(uint256 _auctionIndex) external {
        ...
        require(
            ...
            "AuctionMarket: auction has bids"
        );
